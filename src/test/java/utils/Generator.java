...
public class Generator {
	...
	public static void gerar() {
		...
		try {
			...
			PdfWriter.getInstance(document, new FileOutputStream("./target/"+result+"TESTANDO"+".pdf"));
			document.open();
			document.newPage();
	...
	public static void CRMCOVER() {
		gerar();
		addExternalImage("src/main/resources/imagens/logo.jpg/", Element.ALIGN_JUSTIFIED, 300f, 150f);
		Generator.addFormatedText("Automation : THIAGO HENRIQUE \n"  + "\n" + "Cenario: Cadastro ",
